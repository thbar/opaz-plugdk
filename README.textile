...
Be sure to read the introduction blog post here:

"http://blog.logeek.fr/2009/11/17/how-to-prototype-vst-audio-plugins-with-jruby-and-java":http://blog.logeek.fr/2009/11/17/how-to-prototype-vst-audio-plugins-with-jruby-and-java
...
Basic GUI support has just been added. Example:
...
TODO: allow to reuse existing IRB stuff from your own editor.
...
* (DONE)fix buggy parameters names (display "Cut-off" instead of the ruby variable name)
...
Thibaut Barrère and daniel (author of jVSTwRapper).